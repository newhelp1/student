...
import com.wyf.stu.service.IGradeService;
import com.wyf.stu.entity.Grade;
...
public class GradeController {
    ...
    public Result delete(@PathVariable Integer id) {
        ...
        queryWrapper.eq(Select::getGradeId,id);
        int count = selectService.count(queryWrapper);
        if (count>0){
            return Result.error(Constants.CODE_400,"该年级有关联的专业课，请先操作专业的课程");
        }
    ...
    public Result deleteBatch(@RequestBody List<Integer> ids) {
        ...
        return Result.success(gradeService.removeByIds(ids));
    }
    ...
    public Result findPage(@RequestParam Integer pageNum,
        ...
        return Result.success(gradeService.page(new Page<>(pageNum, pageSize)));
    }
}
